...
<section class="page-title page-title-1" id="page-title">
    <div class="page-title-wrap bg-overlay bg-overlay-dark-2">
        <div class="bg-section"><img src="<?php echo e(asset('assets/images/page-titles/1.jpg'), false); ?>" alt="Background" /></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        ...
                        <div class="title-action"> <a class="btn btn--primary" href="<?php echo e(route('service'), false); ?>"> <span>our
                        ...
                        <!-- <div class="col-12 col-lg-7">
                            <div class="block-left">
                                ...
                                <p>The increase in extreme weather events and rising sea levels are unmistakable signs
                                    ...
                                    class="btn btn--secondary" href="<?php echo e(route('about'), false); ?>">read more <i
            ...
            <div class="col-12 col-lg-4">
                <div class="more-features">
                    <p>If you have any questions or need help, feel free to contact with our team, or you can call us
                        ...
                        class="btn btn--bordered btn--white" href="<?php echo e(route('about'), false); ?>">
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="<?php echo e(route('singelProject'), false); ?>"></a><img
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject'), false); ?>">expanding The Solar Supply Chain
                                    ...
                                    <div class="project-more"> <a class="btn btn--bordered btn--white"
                                            href="<?php echo e(route('singelProject'), false); ?>">explore more <i
                        ...
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject'), false); ?>">Addressing Wind Energy Innovation
                                                Challenges</a></h4>
                                    </div>
                                    <div class="project-desc">
                        ...
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject'), false); ?>">Smarter Ways to Manage EV Charging
                        ...
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject'), false); ?>">New Public Attitude Tracker Towards
