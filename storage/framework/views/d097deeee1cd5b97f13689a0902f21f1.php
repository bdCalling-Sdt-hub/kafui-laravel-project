...
<!--
      ...
      <section class="page-title page-title-1" id="page-title">
        <div class="page-title-wrap bg-overlay bg-overlay-dark-2">
          <div class="bg-section"><img src="<?php echo e(asset('assets/images/page-titles/1.jpg')); ?>" alt="Background"/></div>
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-5">
                <div class="title">
                  ...
                  <div class="title-action"> <a class="btn btn--primary" href="<?php echo e(route('service')); ?>"> <span>our services</span><i class="energia-arrow-right"></i></a><a class="btn-video btn-video-2 popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-6 offset-lg-1">
                ...
                <div class="actions-holder"><a class="btn btn--primary btn--inversed" href="<?php echo e(route('contact')); ?>">
                     get started<i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white" href="<?php echo e(route('about')); ?>">explore our plans</a></div>
              </div>
            </div>
            <!-- End .row-->
          </div>
          ...
          <div class="row"> 
            <div class="col-12 col-lg-4">
              <div class="more-features"> 
                <p>If you have any questions or need help, feel free to contact with our team, or you can call us any time <a href="tel:01061245741">(002) 01061245741</a></p><a class="btn btn--bordered btn--white" href="<?php echo e(route('about')); ?>">
            ...
            <div class="col-12">
              <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="1" data-autoplay="true" data-nav="false" data-dots="true" data-space="30" data-loop="true" data-speed="3000">
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('singelProject')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/1.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                                    <div class="project-cat"><a href="<?php echo e(route('project')); ?>">finance</a><a href="<?php echo e(route('project')); ?>">supply chain</a>
                                    </div>
                                    <div class="project-title">
                                      <h4><a href="<?php echo e(route('singelProject')); ?>">expanding The Solar Supply Chain Finance Program</a></h4>
                                    </div>
                                    ...
                                    <div class="project-more"> <a class="btn btn--bordered btn--white" href="<?php echo e(route('singelProject')); ?>">explore more <i class="energia-arrow-right"></i></a></div>
                                  </div>
                                  <!-- End .project-content -->
                                </div>
                              </div>
                            ...
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('singelProject')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/2.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                            ...
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('singelProject')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/3.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                                    <div class="project-cat"><a href="<?php echo e(route('project')); ?>">eco</a><a href="<?php echo e(route('project')); ?>">green energy</a>
                                    </div>
                                    <div class="project-title">
                                      <h4><a href="<?php echo e(route('singelProject')); ?>">Smarter Ways to Manage EV Charging Infrastructures</a></h4>
                                    </div>
                                    <div class="project-desc">
                            ...
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('singelProject')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/4.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                                    <div class="project-cat"><a href="<?php echo e(route('project')); ?>">eco</a><a href="<?php echo e(route('project')); ?>">green energy</a>
                                    </div>
                                    <div class="project-title">
                                      <h4><a href="<?php echo e(route('singelProject')); ?>">New Public Attitude Tracker Towards Renewable Energy</a></h4>
                                    </div>
                                    <div class="project-desc">
        ...
        <div class="container">
          <div class="contact-panel contact-panel-3">
            <div class="heading heading-light heading-6">
              ...
              <div class="contact-action"><a class="btn btn--white" href="<?php echo e(route('about')); ?>">learn more <i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white" href="<?php echo e(route('faq')); ?>">our core values</a></div>
...
<?php echo $__env->make('Frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\kafio\resources\views\Frontend\about.blade.php ENDPATH**/ ?>