        ...
        <nav class="navbar navbar-expand-lg navbar-sticky" id="primary-menu"><a class="navbar-brand" href="<?php echo e(url('/'), false); ?>"><img class="logo logo-dark" style="width:100px" src="<?php echo e(asset('assets/images/logo/logo-dark.png'), false); ?>" alt="Energia Logo"/><img class="logo logo-mobile" src="<?php echo e(asset('assets/images/logo/logo-mobile.png'), false); ?>" alt="Energia Logo"/></a>
          ...
          <div class="collapse navbar-collapse" id="navbarContent">
                        <ul class="navbar-nav me-auto">   
                          ...
                          <li class="nav-item " id="home" data-hover=""><a href="<?php echo e(url('/'), false); ?>"><span>Home</span></a></li>
                          <li class="nav-item " id="service"  data-hover=""><a href="<?php echo e(route('service'), false); ?>"><span>Service</span></a></li>
                          <li class="nav-item "  id="pricing" data-hover=""><a href="<?php echo e(route('pricing'), false); ?>"><span>Pricing & Plans</span></a></li>
                          <li class="nav-item "  id="about" data-hover=""><a href="<?php echo e(route('about'), false); ?>"><span>About</span></a></li>                       
                          <li class="nav-item "  id="faq" data-hover=""><a href="<?php echo e(route('faq'), false); ?>"><span>Faq</span></a></li>
