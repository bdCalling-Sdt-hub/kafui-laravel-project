...
<!--
      ...
      <section class="page-title page-title-6" id="page-title">
        <div class="page-title-wrap bg-overlay bg-overlay-dark-3">
          <div class="bg-section"><img src="<?php echo e(asset('assets/images/page-titles/6.jpg'), false); ?>" alt="Background"/></div>
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-5">
                <div class="title">
                  ...
                  <div class="title-action"> <a class="btn btn--bordered btn--white" href="<?php echo e(route('contact'), false); ?>"> <span>learn more</span><i class="energia-arrow-right"></i></a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="faqs faqs-2" id="faqs-1">
        ...
        <div class="container">
          <div class="more-faqs">
            <p>Sustainable, reliable & affordable energy systems, <a href="<?php echo e(route('service'), false); ?>">find your solutions now! </a></p>
          </div>
        </div>
        <!-- End .container-->
      </section>
            ...
            <div class="col-12 col-lg-8">
              <div class="img-hotspot"> 
                <div class="img-hotspot-wrap">
                  <div class="img-hotspot-bg"> <img src="<?php echo e(asset('assets/images/background/world-map-dark.png'), false); ?>" alt="image"/></div>
...
<?php echo $__env->make('Frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\kafio\resources\views/Frontend/faq.blade.php ENDPATH**/ ?>