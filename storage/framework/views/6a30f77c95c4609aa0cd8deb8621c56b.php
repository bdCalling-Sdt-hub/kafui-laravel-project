...
<!--
      ...
      <section class="page-title page-title-6" id="page-title">
        <div class="page-title-wrap bg-overlay bg-overlay-dark-3">
          <div class="bg-section"><img src="<?php echo e(asset('assets/images/page-titles/6.jpg')); ?>" alt="Background"/></div>
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-5">
                <div class="title">
                  ...
                  <div class="title-action"> <a class="btn btn--bordered btn--white" href="<?php echo e(route('contact')); ?>"> <span>learn more</span><i class="energia-arrow-right"></i></a></div>
                </div>
              </div>
            </div>
          </div>
