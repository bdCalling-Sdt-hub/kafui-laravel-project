...
<!--
      ...
      <section class="page-title page-title-7" id="page-title">
        <div class="page-title-wrap bg-overlay bg-overlay-dark-3">
          <div class="bg-section"><img src="<?php echo e(asset('assets/images/page-titles/7.jpg'), false); ?>" alt="Background"/></div>
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-5">
                <div class="title">
                  ...
                  <div class="title-action"> <a class="btn btn--bordered btn--white" href="<?php echo e(route('contact'), false); ?>"> <span>our core values</span></a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row"> 
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="<?php echo e(asset('assets/images/projects/gallery/1.jpg'), false); ?>" alt=" item"/>
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="<?php echo e(asset('assets/images/projects/gallery/2.jpg'), false); ?>" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="<?php echo e(asset('assets/images/projects/gallery/3.jpg'), false); ?>" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="<?php echo e(asset('assets/images/projects/gallery/4.jpg'), false); ?>" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="<?php echo e(asset('assets/images/projects/gallery/5.jpg'), false); ?>" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
                        <div class="project-zoom"><i class="far fa-eye"></i><a class="img-gallery-item" href="<?php echo e(asset('assets/images/projects/full/5.jpg'), false); ?>" title="fossil resources item"></a></div>
                      </div>
                      <!-- End .project-action -->
                    </div>
                    <!-- End .project-hover-->
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="<?php echo e(asset('assets/images/projects/gallery/6.jpg'), false); ?>" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
          ...
          <div class="row">
            <div class="col-12 col-md-6 col-lg-4 content d-none team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="<?php echo e(asset('assets/images/projects/gallery/1.jpg'), false); ?>" alt=" item"/>
                    <div class="project-hover">
          ...
          <div class="row">
            <div class="col-12 text-center"><a class="btn btn--white justify-content-center" id="loadMore" href="#">Load More</a></div>
          </div>
          <!-- End .row-->
        </div>
        <!-- End .container-->
...
<?php echo $__env->make('Frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\kafio\resources\views\Frontend\gallery.blade.php ENDPATH**/ ?>