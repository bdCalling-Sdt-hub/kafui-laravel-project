            ...
            <div class="title">
              ...
              <div class="row"> 
                <div class="col-12 col-lg-5">
                  ...
                  <div class="title-action"> <a class="btn btn--primary btn--inversed" href="<?php echo e(route('contact')); ?>">
                ...
                <div class="widget widget-services">
                  ...
                  <div class="widget-content">
                    <ul class="list-unstyled">
                      <li><a href="<?php echo e(route('singelService')); ?>"> <span>solar panels</span><i class="energia-arrow-right"></i></a></li>
                      <li><a href="<?php echo e(route('singelService')); ?>"> <span>wind turbines</span><i class="energia-arrow-right"></i></a></li>
                      <li><a href="<?php echo e(route('singelService')); ?>"> <span>hydropower plants</span><i class="energia-arrow-right"></i></a></li>
                      <li><a href="<?php echo e(route('singelService')); ?>"> <span>fossil resources</span><i class="energia-arrow-right"></i></a></li>
                      <li><a href="<?php echo e(route('singelService')); ?>"> <span>battery materials</span><i class="energia-arrow-right"></i></a></li>
                      <li><a href="<?php echo e(route('singelService')); ?>"> <span>charge controllers</span><i class="energia-arrow-right"></i></a></li>
                    </ul>
                  </div>
                </div>
                <!-- End .widget-services -->
                <!-- Reservation-->
                <div class="widget widget-reservation"><img src="<?php echo e(asset('assets/images/blog/sidebar/reservation.jpg')); ?>" alt="img"/>
                  <div class="widget-content"><i class="flaticon-040-green-energy"></i>
                    <p>Please feel welcome to contact our friendly reception staff with any general or medical enquiry call us</p><a class="btn btn--bordered btn--white" href="<?php echo e(route('contact')); ?>">schedule an appintment</a><a href="tel:0106123214"><span class="energia-phone-Icon"></span> 0106123214</a>
                  </div>
                </div>
              ...
              <div class="service-entry">
                <div class="entry-content">
                  <div class="entry-introduction entry-infos">
                    ...
                    <div class="row"> 
                      <div class="col-12 col-md-6"><img src="<?php echo e(asset('assets/images/services/single/1.jpg')); ?>" alt="image"/></div>
                      <div class="col-12 col-md-6"><img src="<?php echo e(asset('assets/images/services/single/2.jpg')); ?>" alt="image"/></div>
                    </div>
                  </div>
                  <div class="entry-stats entry-infos">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-lg-6"> <img class="entry-chart" src="<?php echo e(asset('assets/images/charts/chart-1.png')); ?>" alt="Chart image"/></div>
                    </div>
                  </div>
                  <div class="entry-processes">
                    <div class="entry-body">
                      <div class="process-icon"> 
                        <div class="bg-section"> <img src="<?php echo e(asset('assets/images/counters/1.jpg')); ?>" alt="img"/></div><i class="flaticon-020-factory"></i>
                      </div>
                  ...
                  <div class="entry-video entry-infos">
                    ...
                    <div class="video video-3" id="video-3">
                      <div class="bg-section"><img src="<?php echo e(asset('assets/images/video/3.jpg')); ?>" alt="background"/></div><a class="popup-video btn-video btn-video-2" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i></a>
                      <!-- End .popup-video-->
                    </div>
                    <!-- End .video-->
                  </div>
