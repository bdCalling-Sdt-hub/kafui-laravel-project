...
<?php $__env->startSection('title'); ?>Request queate <?php $__env->stopSection(); ?>
        ...
        <div class="container">
          <div class="contact-panel contact-panel-3">
            <div class="heading heading-6">
              ...
              <div class="contact-action"><a class="btn btn--primary" href="<?php echo e(route('about')); ?>">learn more <i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white" href="<?php echo e(route('faq')); ?>">our core values</a></div>
              <div class="contact-quote contact-quote-3"> <img src="<?php echo e(asset('assets/images/icons/noteicon-2.png')); ?>" alt="icon"/>
    ...
    <div class="mb-20">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" id="contact-projects" name="contact-projects" placeholder="Add other data" cols="30" rows="10"></textarea>
            </div>
        </div>
    </div>
    <div class="mb-20">
            ...
            <div class="col-12">
                ...
                <div class="custom-radio-group" id="custom-radio-group">
                    <div class="custom-control">
                        <input class="custom-control-input" type="radio" id="customRadioInline1" name="customRadioInline1" value="all" />
                        <label for="customRadioInline1">All</label>
                    </div>
                    <div class="custom-control">
                        <input class="custom-control-input" type="radio" id="customRadioInline2" name="customRadioInline1" value="email" />
                        <label for="customRadioInline2">Email</label>
                    </div>
                    <div class="custom-control">
                        <input class="custom-control-input" type="radio" id="customRadioInline3" name="customRadioInline1" value="phone" />
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="custom-radio-group" id="custom-radio-group-2">
                    <div class="custom-control">
                        <input class="custom-control-input" type="radio" id="customRadioInline4" name="customRadioInline4" value="agree" />
...
<?php echo $__env->make('Frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\kafio\resources\views/Frontend/rquest_queat.blade.php ENDPATH**/ ?>