<a href='javascript:void(0);' class='text-muted inline-upload-trigger' data-target="<?php echo e($target, false); ?>">
    <i class="icon-upload"></i>&nbsp;<?php echo $value; ?>
...
<?php /**PATH E:\xampp\htdocs\kafio\vendor\open-admin-org\open-admin\resources\views\grid\inline-edit\upload.blade.php ENDPATH**/ ?>