            ...
            <div class="row">
              <div class="col-12 col-lg-5">
                <div class="title">
                  ...
                  <div class="title-action"> <a class="btn btn--white" href="<?php echo e(route('contact')); ?>"> <span>contact us</span><i class="energia-arrow-right"></i></a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="pricing pricing-1" id="pricing-1">
          ...
          <div class="row"> 
            <div class="col-12 col-lg-6 offset-lg-3"> 
              <div class="heading heading-16 text-center">
                <p class="heading-subtitle">Pricing And Plans</p>
                ...
                <div class="pricing-panel">
                  <div class="pricing-body">
                    <div class="pricing-heading">
                      ...
                      <p class="pricing-desc">The perfect plan for small business.</p>
                    </div>
                    <div class="pricing-price">
                      <p> <span class="currency">$50</span><span class="time"> Month</span></p><a class="btn btn--secondary" href="<?php echo e(route('contact')); ?>">purchase now <i class="energia-arrow-right"></i></a>
                    </div>
                    <div class="pricing-list"> 
                      <p>Fast project turnaround time, substantial cost savings &amp; quality standards.</p>
                ...
                <div class="pricing-panel active">
                  <div class="pricing-body">
                    <div class="pricing-heading">
                      ...
                      <p class="pricing-desc">The perfect plan for larger companies.</p>
                    </div>
                    <div class="pricing-price">
                      <p> <span class="currency">$70</span><span class="time"> Month</span></p><a class="btn btn--secondary" href="<?php echo e(route('contact')); ?>">purchase now <i class="energia-arrow-right"></i></a>
                    </div>
                    <div class="pricing-list"> 
                      <p>Fast project turnaround time, substantial cost savings &amp; quality standards.</p>
                      <ul class="advantages-list list-unstyled">
                ...
                <div class="pricing-panel">
                  <div class="pricing-body">
                    <div class="pricing-heading">
                      ...
                      <p class="pricing-desc">The perfect plan for bigger enterprises.</p>
                    </div>
                    <div class="pricing-price">
                      <p> <span class="currency">$90</span><span class="time"> Month</span></p><a class="btn btn--secondary" href="<?php echo e(route('contact')); ?>">purchase now <i class="energia-arrow-right"></i></a>
                    </div>
                    <div class="pricing-list"> 
                      <p>Fast project turnaround time, substantial cost savings &amp; quality standards.</p>
                      <ul class="advantages-list list-unstyled">
        ...
        <div class="container">
          <div class="more-prices">
            <p>Sustainable, reliable & affordable energy systems, <a href="<?php echo e(route('service')); ?>">find your solutions now! </a></p>
          </div>
        </div>
        <!-- End .container-->
      </section>
                ...
                <div class="img-card img-card-2 bg-overlay bg-overlay-theme">
                  ...
                  <div class="card-content">
                    ...
                    <div class="content-bottom">
                      ...
                      </ul><a class="btn btn--white" href="<?php echo e(route('contact')); ?>">contact us <i class="energia-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
...
<?php echo $__env->make('Frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\kafio\resources\views\Frontend\pricing.blade.php ENDPATH**/ ?>