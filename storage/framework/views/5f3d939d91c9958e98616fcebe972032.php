...
<table class="table">
  ...
  <tbody id="table-body">
    ...
    <tr draggable="true" ondragstart="handleDragStart(event)" ondragover="handleDragOver(event)" ondrop="handleDrop(event)" ondragend="handleDragEnd(event)">
        ...
        <td>
        <label for="consoltant" class="form-label"><?php echo e($item->title, false); ?></label>
        ...
        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value=<?php echo e($items, false); ?>><?php echo e($items, false); ?></option>
      ...
      <td>
        ...
        <a href="/task2/destroy2/<?php echo e($item->id, false); ?>">
            <button  class="btn btn-danger">Delete</button>
        </a>
      </td>
        <?php else: ?>
        <td>
        <label class="form-label"><?php echo e($item->title, false); ?></label>
        <input type=<?php echo e($item->type, false); ?> class="form-control">
      </td>
      <td><?php echo e($item->created_at, false); ?></td>
      <td>
        <button  class="btn btn-success">Edit</button>
...
<?php /**PATH E:\xampp\htdocs\kafio\resources\views\taskview.blade.php ENDPATH**/ ?>