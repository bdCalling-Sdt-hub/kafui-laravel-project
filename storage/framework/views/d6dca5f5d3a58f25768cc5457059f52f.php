        ...
        <div class="container-fluid pe-0 ps-0">
          <div class="slider-carousel owl-carousel carousel-navs carousel-dots" data-slide="1" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="true" data-space="0" data-loop="true" data-speed="800">
            ...
            <div class="slide bg-overlay bg-overlay-dark-slider">
              <div class="bg-section"><img src="<?php echo e(asset('assets/images/sliders/1.jpg')); ?>" alt="Background"/></div>
              <div class="container">
                <div class="row">
                  <div class="col-12 col-lg-7">
                    <div class="slide-content">
                      ...
                      <div class="slide-action">
                        ...
                        </div><a class="btn btn--primary" href="<?php echo e(route('service')); ?>"> <span>our services</span><i class="energia-arrow-right"></i></a>
                      </div>
                    </div>
                    <!-- End .slide-content -->
                  </div>
                  <div class="col-12 col-lg-3 offset-lg-2 d-flex"> 
                    <div class="slider-panel-holder"> 
                      <div class="slider-panel"><i class="panel-icon flaticon-028-greenhouse"></i>
                        ...
                        <p class="panel-desc">Utilizing latest processes solutions, and decades of work experience.</p><a href="<?php echo e(asset('about')); ?>"><i class="energia-arrow-right"> </i></a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <!--  Start .slide-->
            <div class="slide bg-overlay bg-overlay-dark-slider">
              <div class="bg-section"><img src="<?php echo e(asset('assets/images/sliders/2.jpg')); ?>" alt="Background"/></div>
              <div class="container">
                <div class="row">
                  <div class="col-12 col-lg-7">
                    <div class="slide-content">
                  ...
                  <div class="col-12 col-lg-3 offset-lg-2 d-flex"> 
                    <div class="slider-panel-holder"> 
                      <div class="slider-panel"><i class="panel-icon flaticon-019-electric-tower"></i>
                        ...
                        <p class="panel-desc">Growing demand of electricity while protecting our climate.</p><a href="<?php echo e(asset('about')); ?>"><i class="energia-arrow-right"> </i></a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-12 col-lg-5">
              <div class="about-img">
                <div class="about-img-holder bg-overlay">
                  <div class="bg-section"><img src="<?php echo e(asset('assets/images/about/1.jpg')); ?>" alt="about Image"/></div>
                </div>
                <div>
                  <!-- Start .counter-->
                  <div class="counter">
          ...
          <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-6 offset-lg-1">
                ...
                <div class="actions-holder"><a class="btn btn--primary btn--inversed" href="<?php echo e(asset('contact')); ?>">
                     get started<i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white" href="<?php echo e(asset('about')); ?>">explore our plans</a></div>
              </div>
            </div>
            <!-- End .row-->
          </div>
            ...
            <div>
              <div class="feature-panel-holder" data-hover="">
                <div class="feature-panel">
                  ...
                  </div><a href="<?php echo e(asset('about')); ?>"><i class="energia-arrow-right"></i> <span>explore more</span> </a>
                </div>
                <!-- End .feature-panel-->
              </div>
            </div>
          ...
          <div class="row"> 
            <div class="col-12 col-lg-4">
              <div class="more-features"> 
                <p>If you have any questions or need help, feel free to contact with our team, or you can call us any time <a href="tel:01061245741">(002) 01061245741</a></p><a class="btn btn--bordered btn--white" href="<?php echo e(asset('about')); ?>">
            ...
            <div class="col-12 col-lg-8">
              ...
              <div class="video video-1 bg-overlay bg-overlay-video" id="video-1">
                <div class="bg-section"><img src="<?php echo e(asset('assets/images/video/1.jpg')); ?>" alt="background"/></div><a class="popup-video btn-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i><span>watch our video!</span></a>
                <!-- End .popup-video-->
              </div>
            </div>
          </div>
      ...
      <section class="services services-1 bg-grey" id="services-1">
        <div class="container">
            ...
            <div>
              <div class="service-panel">
                ...
                <div class="service-content">
                  ...
                  </ul><a class="btn btn--secondary" href="<?php echo e(route('singelService')); ?>">read more <i class="energia-arrow-right"></i></a>
                </div>
              </div>
              <!-- End .service-panel-->
            </div>
          ...
          <div class="more-services">
            <p>Sustainable, reliable & affordable energy systems, <a href="<?php echo e(route('service')); ?>">Find Your Solution Now! </a></p>
          </div>
          <!-- End more-services-->
        </div>
        <!-- End .container-->
            ...
            <div class="col-12 col-lg-8">
              <div class="img-hotspot"> 
                <div class="img-hotspot-wrap">
                  <div class="img-hotspot-bg"> <img src="<?php echo e(asset('assets/images/background/world-map-dark.png')); ?>" alt="image"/></div>
              ...
              <div class="carousel owl-carousel carousel-nav carousel-dots" data-slide="2" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="true" data-space="40" data-loop="true" data-speed="800">
                <div class="testimonial-panel">
                  <div class="testimonial-body">
                    <div class="testimonial-img"> <img src="<?php echo e(asset('assets/images/testimonial/3.jpg')); ?>" alt="Testimonial Author"/></div>
                ...
                <div class="testimonial-panel">
                  <div class="testimonial-body">
                    <div class="testimonial-img"> <img src="<?php echo e(asset('assets/images/testimonial/4.jpg')); ?>" alt="Testimonial Author"/></div>
                    <div class="testimonial-content">
                ...
                <div class="testimonial-panel">
                  <div class="testimonial-body">
                    <div class="testimonial-img"> <img src="<?php echo e(asset('assets/images/testimonial/5.jpg')); ?>" alt="Testimonial Author"/></div>
                    <div class="testimonial-content">
                      <p>“They helped lead me through the process of system selection, site layout and placing my order. They were very knowledgeable and has provided guidance each step.”</p>
                      <div class="testimonial-meta"> 
                        <h6>john doe</h6>
            ...
            <div class="col-12">
              <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="1" data-autoplay="true" data-nav="false" data-dots="true" data-space="30" data-loop="true" data-speed="3000">
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('project')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/1.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                                    ...
                                    <div class="project-more"> <a class="btn btn--bordered btn--white" href="<?php echo e(route('project')); ?>">explore more <i class="energia-arrow-right"></i></a></div>
                                  </div>
                                  <!-- End .project-content -->
                                </div>
                              </div>
                            ...
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('project')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/2.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                                    <div class="project-cat"><a href="projects-standard.html">energy</a><a href="projects-standard.html">green energy</a>
                                    </div>
                                    <div class="project-title">
                                      <h4><a href="<?php echo e(route('project')); ?>">Addressing Wind Energy Innovation Challenges</a></h4>
                                    </div>
                                    <div class="project-desc">
                            ...
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('project')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/3.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                                    <div class="project-cat"><a href="projects-standard.html">eco</a><a href="projects-standard.html">green energy</a>
                                    </div>
                                    <div class="project-title">
                                      <h4><a href="<?php echo e(route('project')); ?>">Smarter Ways to Manage EV Charging Infrastructures</a></h4>
                                    </div>
                                    <div class="project-desc">
                            ...
                            <div>
                              <div class="project-panel" data-hover="">
                                <div class="project-panel-holder">
                                  <div class="project-img"><a class="link" href="<?php echo e(route('project')); ?>"></a><img src="<?php echo e(asset('assets/images/projects/modern/4.jpg')); ?>" alt="project image"/></div>
                                  <!-- End .project-img-->
                                  <div class="project-content"> 
                                    <div class="project-cat"><a href="projects-standard.html">eco</a><a href="projects-standard.html">green energy</a>
                                    </div>
                                    <div class="project-title">
                                      <h4><a href="<?php echo e(route('project')); ?>">New Public Attitude Tracker Towards Renewable Energy</a></h4>
                                    </div>
                                    <div class="project-desc">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="carousel owl-carousel" data-slide="6" data-slide-rs="2" data-autoplay="true" data-nav="false" data-dots="false" data-space="0" data-loop="true" data-speed="3000">
                <div class="client"><a href="javascript:void(0)"> </a><img src="<?php echo e(asset('assets/images/clients/1.png')); ?>" alt="client"/></div>
                <div class="client"><a href="javascript:void(0)"> </a><img src="<?php echo e(asset('assets/images/clients/2.png')); ?>" alt="client"/></div>
                <div class="client"><a href="javascript:void(0)"> </a><img src="<?php echo e(asset('assets/images/clients/3.png')); ?>" alt="client"/></div>
                <div class="client"><a href="javascript:void(0)"> </a><img src="<?php echo e(asset('assets/images/clients/4.png')); ?>" alt="client"/></div>
                <div class="client"><a href="javascript:void(0)"> </a><img src="<?php echo e(asset('assets/images/clients/5.png')); ?>" alt="client"/></div>
                <div class="client"><a href="javascript:void(0)"> </a><img src="<?php echo e(asset('assets/images/clients/6.png')); ?>" alt="client"/></div>
              </div>
            </div>
          </div>
          <!-- End .row-->
        ...
        <div class="container">
          <div class="contact-panel contact-panel-3">
            <div class="heading heading-light heading-6">
              ...
              <div class="contact-action"><a class="btn btn--white" href="<?php echo e(asset('about')); ?>">learn more <i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white" href="<?php echo e(route('faq')); ?>">our core values</a></div>
...
<?php echo $__env->make('Frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\kafio\resources\views\Frontend\home.blade.php ENDPATH**/ ?>