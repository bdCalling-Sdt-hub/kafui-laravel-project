    ...
    <div class="container-fluid pe-0 ps-0">
        <div class="slider-carousel owl-carousel carousel-navs carousel-dots" data-slide="1" data-slide-rs="1"
            ...
            <div class="slide bg-overlay bg-overlay-dark-slider">
                <div class="bg-section"><img src="<?php echo e(asset('assets/images/sliders/1.jpg'), false); ?>" alt="Background" /></div>
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="slide-content">
                                <h1 class="slide-headline">energize society using sustainable &amp; reliable energy</h1>
                                <p class="slide-desc">a world wide distrbuter of solar supplies &amp; knowledgable
                                    service.</p>
                                <div class="slide-action">
                                    ...
                                    </div><a class="btn btn--primary" href="<?php echo e(route('service'), false); ?>"> <span>our
                                            services</span><i class="energia-arrow-right"></i></a>
                                </div>
                            </div>
                            <!-- End .slide-content -->
                        </div>
                        <div class="col-12 col-lg-3 offset-lg-2 d-flex">
                            <div class="slider-panel-holder">
                                <div class="slider-panel"><i class="panel-icon flaticon-028-greenhouse"></i>
                                    ...
                                    <p class="panel-desc">Utilizing latest processes solutions, and decades of work
                                        experience.</p><a href="<?php echo e(asset('about'), false); ?>"><i class="energia-arrow-right">
                                        </i></a>
                                </div>
                            </div>
                        </div>
            ...
            <!--  Start .slide-->
            <div class="slide bg-overlay bg-overlay-dark-slider">
                <div class="bg-section"><img src="<?php echo e(asset('assets/images/sliders/2.jpg'), false); ?>" alt="Background" /></div>
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="slide-content">
                        ...
                        <div class="col-12 col-lg-3 offset-lg-2 d-flex">
                            <div class="slider-panel-holder">
                                <div class="slider-panel"><i class="panel-icon flaticon-019-electric-tower"></i>
                                    ...
                                    <p class="panel-desc">Growing demand of electricity while protecting our climate.
                                    </p><a href="<?php echo e(asset('about'), false); ?>"><i class="energia-arrow-right"> </i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-5">
                <div class="about-img">
                    <div class="about-img-holder bg-overlay">
                        <div class="bg-section"><img src="<?php echo e(asset('assets/images/about/1.jpg'), false); ?>" alt="about Image" />
                        </div>
                    </div>
                    <div>
                        <!-- Start .counter-->
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                ...
                                <p>The increase in extreme weather events and rising sea levels are unmistakable signs
                                    ...
                                    class="btn btn--secondary" href="<?php echo e(asset('about'), false); ?>">read more <i
        ...
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 offset-lg-1">
                    ...
                    <div class="actions-holder"><a class="btn btn--primary btn--inversed" href="<?php echo e(asset('contact'), false); ?>">
                            get started<i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white"
                            href="<?php echo e(asset('about'), false); ?>">explore our plans</a></div>
                </div>
            </div>
            <!-- End .row-->
        </div>
                    ...
                    <div class="feature-panel">
                        ...
                        <div class="feature-content">
                            ...
                            <p>Save money on utilities or increase the value of your home by installing solar panels as
                                a great option.</p>
                        </div><a href="<?php echo e(asset('about'), false); ?>"><i class="energia-arrow-right"></i> <span>explore more</span>
                        </a>
                    </div>
                    <!-- End .feature-panel-->
                </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="more-features">
                    <p>If you have any questions or need help, feel free to contact with our team, or you can call us
                        ...
                        class="btn btn--bordered btn--white" href="<?php echo e(asset('about'), false); ?>">
            ...
            <div class="col-12 col-lg-8">
              ...
              -->
                <div class="video video-1 bg-overlay bg-overlay-video" id="video-1">
                    <div class="bg-section"><img src="<?php echo e(asset('assets/images/video/1.jpg'), false); ?>" alt="background" /></div>
...
<section class="services services-1 bg-grey" id="services-1">
    <div class="container">
        ...
        <div class="carousel owl-carousel carousel-dots dots-side" data-slide="3" data-slide-rs="1" data-autoplay="true"
            ...
            <div>
                ...
                <div class="service-panel">
                    ...
                    <div class="service-content">
                        <h4><a href="<?php echo e(route('service'), false); ?>">solar panels<br />services</a></h4>
                        ...
                        </ul><a class="btn btn--secondary" href="<?php echo e(route('service'), false); ?>">read more <i
                                class="energia-arrow-right"></i></a>
                    </div>
                </div>
                <!-- End .service-panel-->
            ...
            <div>
                <div class="service-panel">
                    ...
                    <div class="service-content">
                        <h4><a href="<?php echo e(route('service'), false); ?>">wind turbines<br />services</a></h4>
            ...
            <div>
                <div class="service-panel">
                    ...
                    <div class="service-content">
                        <h4><a href="<?php echo e(route('service'), false); ?>">hydropower plants<br />services</a></h4>
        ...
        <div class="more-services">
            <p>Sustainable, reliable & affordable energy systems, <a href="<?php echo e(route('service'), false); ?>">Find Your Solution Now!
                </a></p>
        </div>
        <!-- End more-services-->
    </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="img-hotspot">
                    <div class="img-hotspot-wrap">
                        <div class="img-hotspot-bg"> <img src="<?php echo e(asset('assets/images/background/world-map-dark.png'), false); ?>"
                                alt="image" /></div>
                ...
                <div class="carousel owl-carousel carousel-nav carousel-dots" data-slide="2" data-slide-rs="1"
                    ...
                    <div class="testimonial-panel">
                        <div class="testimonial-body">
                            <div class="testimonial-img"> <img src="<?php echo e(asset('assets/images/testimonial/3.jpg'), false); ?>"
                    ...
                    <div class="testimonial-panel">
                        <div class="testimonial-body">
                            <div class="testimonial-img"> <img src="<?php echo e(asset('assets/images/testimonial/4.jpg'), false); ?>"
                                    alt="Testimonial Author" /></div>
                            <div class="testimonial-content">
                    ...
                    <div class="testimonial-panel">
                        <div class="testimonial-body">
                            <div class="testimonial-img"> <img src="<?php echo e(asset('assets/images/testimonial/5.jpg'), false); ?>"
                                    alt="Testimonial Author" /></div>
                            <div class="testimonial-content">
                                <p>“They helped lead me through the process of system selection, site layout and placing
                                    my order. They were very knowledgeable and has provided guidance each step.”</p>
                ...
                <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="1" data-autoplay="true"
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="<?php echo e(route('project'), false); ?>"></a><img
                                        src="<?php echo e(asset('assets/images/projects/modern/1.jpg'), false); ?>" alt="project image" />
                                </div>
                                <!-- End .project-img-->
                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.html">finance</a><a
                                            href="projects-standard.html">supply chain</a>
                                    </div>
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('project'), false); ?>">expanding The Solar Supply Chain Finance
                                                Program</a></h4>
                                    </div>
                                    ...
                                    <div class="project-more"> <a class="btn btn--bordered btn--white"
                                            href="<?php echo e(route('project'), false); ?>">explore more <i
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="<?php echo e(route('project'), false); ?>"></a><img
                                        src="<?php echo e(asset('assets/images/projects/modern/2.jpg'), false); ?>" alt="project image" />
                                </div>
                                <!-- End .project-img-->
                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.html">energy</a><a
                                            href="projects-standard.html">green energy</a>
                                    </div>
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('project'), false); ?>">Addressing Wind Energy Innovation
                                                Challenges</a></h4>
                                    </div>
                                    <div class="project-desc">
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="<?php echo e(route('project'), false); ?>"></a><img
                                        src="<?php echo e(asset('assets/images/projects/modern/3.jpg'), false); ?>" alt="project image" />
                                </div>
                                <!-- End .project-img-->
                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.html">eco</a><a
                                            href="projects-standard.html">green energy</a>
                                    </div>
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('project'), false); ?>">Smarter Ways to Manage EV Charging
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="<?php echo e(route('project'), false); ?>"></a><img
                                        src="<?php echo e(asset('assets/images/projects/modern/4.jpg'), false); ?>" alt="project image" />
                                </div>
                                <!-- End .project-img-->
                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.html">eco</a><a
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('project'), false); ?>">New Public Attitude Tracker Towards Renewable
                                                Energy</a></h4>
                                    </div>
                                    <div class="project-desc">
    ...
    <div class="container">
        <div class="contact-panel contact-panel-3">
            <div class="heading heading-light heading-6">
                ...
                <div class="contact-action"><a class="btn btn--white" href="<?php echo e(asset('about'), false); ?>">learn more <i
