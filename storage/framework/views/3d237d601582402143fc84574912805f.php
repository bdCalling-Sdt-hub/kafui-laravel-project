            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        ...
                        <div class="title-action"> <a class="btn btn--primary" href="<?php echo e(route('service')); ?>"> <span>our
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                ...
                                <p>The increase in extreme weather events and rising sea levels are unmistakable signs
                                    ...
                                    class="btn btn--secondary" href="<?php echo e(route('about')); ?>">read more <i
            ...
            <div class="col-12 col-lg-4">
                <div class="more-features">
                    <p>If you have any questions or need help, feel free to contact with our team, or you can call us
                        ...
                        class="btn btn--bordered btn--white" href="<?php echo e(route('about')); ?>">
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="<?php echo e(route('singelProject')); ?>"></a><img
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject')); ?>">expanding The Solar Supply Chain
                                    ...
                                    <div class="project-more"> <a class="btn btn--bordered btn--white"
                                            href="<?php echo e(route('singelProject')); ?>">explore more <i
                        ...
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject')); ?>">Addressing Wind Energy Innovation
                                                Challenges</a></h4>
                                    </div>
                                    <div class="project-desc">
                        ...
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject')); ?>">Smarter Ways to Manage EV Charging
                        ...
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-title">
                                        <h4><a href="<?php echo e(route('singelProject')); ?>">New Public Attitude Tracker Towards
