...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <title> @yield('title') Home Main - Energia Responsive Bootstrap 5 energy HTML5 Template</title>
  ...
  <body>
    ...
    <div class="wrapper clearfix" id="wrapperParallax">
      ...
      <header class="header header-light header-topbar header-topbar1 header-shadow" id="navbar-spy">
        ...
        <nav class="navbar navbar-expand-lg navbar-sticky" id="primary-menu"><a class="navbar-brand" href="{{url('/')}}"><img class="logo logo-dark" src="{{asset('assets/images/logo/logo-dark.png')}}" alt="Energia Logo"/><img class="logo logo-mobile" src="{{asset('assets/images/logo/logo-mobile.png')}}" alt="Energia Logo"/></a>
