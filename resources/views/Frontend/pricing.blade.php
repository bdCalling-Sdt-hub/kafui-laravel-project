...
<section class="page-title page-title-4" id="page-title">
    <div class="page-title-wrap bg-overlay bg-overlay-dark-2">
        <div class="bg-section"><img src="{{asset('assets/images/page-titles/4.jpg')}}" alt="Background" /></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        ...
                        <div class="title-action"> <a class="btn btn--white" href="{{route('contact')}}"> <span>contact
...
<section class="pricing pricing-1" id="pricing-1">
                        ...
                        <div class="pricing-body">
                            ...
                            <div class="pricing-price">
                                <p> <span class="currency">$50</span><span class="time"> Month</span></p><a
                                    class="btn btn--secondary" href="{{route('contact')}}">purchase now <i
    ...
    <div class="container">
        <div class="more-prices">
            <p>Sustainable, reliable & affordable energy systems, <a href="{{route('service')}}">find your solutions
                    now! </a></p>
        </div>
    </div>
    <!-- End .container-->
                        ...
                        <div class="card-content">
                            <div class="content-top">
                                <p>As a world wide distributor of solar supplies we endeavor provide fast and
                                    ...
                                    href="{{route('contact')}}"><i class="energia-arrow-right"></i>global office map</a>
                            </div>
                            <div class="content-bottom">
                                ...
                                </ul><a class="btn btn--white" href="{{route('contact')}}">contact us <i
                                        class="energia-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-7 offset-lg-1">
                ...
                <div class="testimonial-thumbs">
                    <div class="testimonial-thumb active" data-hover="">
                        <div class="thumb-img"> <img src="{{asset('assets/images/testimonial/1.jpg')}}"
                    ...
                    <div class="testimonial-thumb" data-hover="">
                        <div class="thumb-img"> <img src="{{asset('assets/images/testimonial/2.jpg')}}"
                                alt="Testimonial Author" /></div>
                        <div class="thumb-body">
                            <h6>john peter</h6>
                            <p>optima inc</p>
                    ...
                    <div class="testimonial-thumb" data-hover="">
                        <div class="thumb-img"> <img src="{{asset('assets/images/testimonial/3.jpg')}}"
                                alt="Testimonial Author" /></div>
                        <div class="thumb-body">
                            <h6>sony blake</h6>
                            <p>koira ind</p>
