...
@section('title')Singe service @endsection
...
<section class="page-title page-title-11" id="page-title">
    <div class="page-title-wrap bg-overlay bg-overlay-dark-3">
        <div class="bg-section"><img src="{{asset('assets/images/page-titles/11.jpg')}}" alt="Background" /></div>
        <div class="container">
            <div class="title">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="title-action"> <a class="btn btn--primary btn--inversed"
                                ...
                                class="btn btn--bordered btn--white" href="{{route('about')}}">explore our plans</a>
                        </div>
                    </div>
                </div>
            </div>
              ...
              -->
                <div class="sidebar sidebar-service">
                    ...
                    <div class="widget widget-reservation"><img
                            src="{{asset('assets/images/blog/sidebar/reservation.jpg')}}" alt="img" />
                ...
                <div class="service-entry">
                        ...
                        <div class="entry-introduction entry-infos">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6"><img src="{{asset('assets/images/services/single/1.jpg')}}"
                                        alt="image" /></div>
                                <div class="col-12 col-md-6"><img src="{{asset('assets/images/services/single/2.jpg')}}"
                                        alt="image" /></div>
                            </div>
                        </div>
                        <div class="entry-stats entry-infos">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6"> <img class="entry-chart"
                                        src="{{asset('assets/images/charts/chart-1.png')}}" alt="Chart image" /></div>
                            </div>
                        </div>
                        <div class="entry-processes">
                            <div class="entry-body">
                                <div class="process-icon">
                                    <div class="bg-section"> <img src="{{asset('assets/images/counters/1.jpg')}}"
                            ...
                            <div class="images-holder">
                                <div class="carousel owl-carousel process-image-carousel" data-slide="1"
                                    ...
                                    data-dots="false" data-space="0" data-loop="false" data-speed="800"><img
                                        src="{{asset('assets/images/processes/1.jpg')}}" alt="process" /><img
                                        src="{{asset('assets/images/processes/2.jpg')}}" alt="process" /><img
                                        src="{{asset('assets/images/processes/3.jpg')}}" alt="process" /></div>
                            </div>
                        </div>
                    ...
                    -->
                            <div class="video video-3" id="video-3">
                                <div class="bg-section"><img src="{{asset('assets/images/video/3.jpg')}}"
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="feature-panel-holder" data-hover="">
                                            <div class="feature-panel feature-panel-2">
                                                ...
                                                </div><a href="{{route('about')}}"><i class="energia-arrow-right"></i>
                                    ...
                                    <div class="project-panel" data-hover="">
                                        <div class="project-panel-holder">
                                            <div class="project-img"><a class="link"
                                                    href="{{route('singelProject')}}"></a><img
                                                    src="{{asset('assets/images/projects/grid-carousel/1.jpg')}}"
                                                    alt="project image" /></div>
                                            <!-- End .project-img-->
                                            <div class="project-content">
                                                <div class="project-title">
                                                    <h4><a href="{{route('singelProject')}}">expanding The Solar Supply
                                ...
                                <div>
                                    <div class="project-panel" data-hover="">
                                        <div class="project-panel-holder">
                                            <div class="project-img"><a class="link"
                                                    href="{{route('singelProject')}}"></a><img
                                                    src="{{asset('assets/images/projects/grid-carousel/2.jpg')}}"
                                                    alt="project image" /></div>
                                            <!-- End .project-img-->
                                            <div class="project-content">
                                                <div class="project-title">
                                                    <h4><a href="{{route('singelProject')}}">Addressing Wind Energy
                                ...
                                <div>
                                    <div class="project-panel" data-hover="">
                                        <div class="project-panel-holder">
                                            <div class="project-img"><a class="link"
                                                    href="{{route('singelProject')}}"></a><img
                                                    src="{{asset('assets/images/projects/grid-carousel/3.jpg')}}"
                                                    alt="project image" /></div>
                                            <!-- End .project-img-->
                                            <div class="project-content">
                                                <div class="project-title">
                                                    <h4><a href="{{route('singelProject')}}">dangerous environment
                                                            impact of gas</a></h4>
                                                </div>
                                ...
                                <div>
                                    <div class="project-panel" data-hover="">
                                        <div class="project-panel-holder">
                                            <div class="project-img"><a class="link"
                                                    href="{{route('singelProject')}}"></a><img
                                                    src="{{asset('assets/images/projects/grid-carousel/4.jpg')}}"
                                                    alt="project image" /></div>
                                            <!-- End .project-img-->
                                            <div class="project-content">
                                                <div class="project-title">
                                                    <h4><a href="{{route('singelProject')}}">New Attitude Towards
                                                            Renewable Energy</a></h4>
                                                </div>
                                                <div class="project-cat"><a href="{{route('project')}}">green
                                                        energy</a><a href="{{route('project')}}">eCO</a>
                                                </div>
                                            </div>
                                            <!-- End .project-content -->
                                        </div>
                                ...
                                <div>
                                    <div class="project-panel" data-hover="">
                                        <div class="project-panel-holder">
                                            <div class="project-img"><a class="link"
                                                    href="{{route('singelProject')}}"></a><img
                                                    src="{{asset('assets/images/projects/grid-carousel/5.jpg')}}"
                                                    alt="project image" /></div>
                                            <!-- End .project-img-->
                                            <div class="project-content">
                                                <div class="project-title">
                                                    <h4><a href="{{route('singelProject')}}">Smarter Way to Manage
                                                            Charging Infrastructures</a></h4>
                                                </div>
                                                <div class="project-cat"><a href="{{route('project')}}">elictrec
                                                        vehicles</a><a href="{{route('project')}}">infrastructures</a>
                                                </div>
                                            </div>
                                            <!-- End .project-content -->
                                        </div>
                                ...
                                <div>
                                    <div class="project-panel" data-hover="">
                                        <div class="project-panel-holder">
                                            <div class="project-img"><a class="link"
                                                    href="{{route('singelProject')}}"></a><img
                                                    src="{{asset('assets/images/projects/grid-carousel/6.jpg')}}"
                                                    alt="project image" /></div>
                                            <!-- End .project-img-->
                                            <div class="project-content">
                                                <div class="project-title">
                                                ...
                                                <div class="project-cat"><a href="{{route('project')}}">wind
                                                        energy</a><a href="{{route('project')}}">innovations</a>
                                                </div>
                                            </div>
                                            <!-- End .project-content -->
                                        </div>
