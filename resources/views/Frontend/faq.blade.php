...
<!--
      ...
      <section class="page-title page-title-6" id="page-title">
        <div class="page-title-wrap bg-overlay bg-overlay-dark-3">
          <div class="bg-section"><img src="{{asset('assets/images/page-titles/6.jpg')}}" alt="Background"/></div>
          <div class="container">
            <div class="row">
      ...
      <section class="faqs faqs-2" id="faqs-1">
        ...
        <div class="container">
          <div class="more-faqs">
            <p>Sustainable, reliable & affordable energy systems, <a href="{{route('service')}}">find your solutions now! </a></p>
          </div>
        </div>
        <!-- End .container-->
      </section>
            ...
            <div class="col-12 col-lg-8">
              <div class="img-hotspot"> 
                <div class="img-hotspot-wrap">
                  <div class="img-hotspot-bg"> <img src="{{asset('assets/images/background/world-map-dark.png')}}" alt="image"/></div>
