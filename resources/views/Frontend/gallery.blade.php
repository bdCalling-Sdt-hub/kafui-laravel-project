...
<!--
      ...
      <section class="page-title page-title-7" id="page-title">
        <div class="page-title-wrap bg-overlay bg-overlay-dark-3">
          <div class="bg-section"><img src="{{asset('assets/images/page-titles/7.jpg')}}" alt="Background"/></div>
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-5">
                <div class="title">
                  ...
                  <div class="title-action"> <a class="btn btn--bordered btn--white" href="{{route('contact')}}"> <span>our core values</span></a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row"> 
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="{{asset('assets/images/projects/gallery/1.jpg')}}" alt=" item"/>
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="{{asset('assets/images/projects/gallery/2.jpg')}}" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="{{asset('assets/images/projects/gallery/3.jpg')}}" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="{{asset('assets/images/projects/gallery/4.jpg')}}" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item ">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="{{asset('assets/images/projects/gallery/5.jpg')}}" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
                        <div class="project-zoom"><i class="far fa-eye"></i><a class="img-gallery-item" href="{{asset('assets/images/projects/full/5.jpg')}}" title="fossil resources item"></a></div>
                      </div>
                      <!-- End .project-action -->
                    </div>
                    <!-- End .project-hover-->
            ...
            <div class="col-12 col-md-6 col-lg-4 team-item">
              <div class="project-panel">
                <div class="project-panel-holder">
                  <div class="project-img"><img src="{{asset('assets/images/projects/gallery/6.jpg')}}" alt=" item"/>
                    <div class="project-hover">
                      <div class="project-action">
